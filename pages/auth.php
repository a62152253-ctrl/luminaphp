  ...
  <div class="auth-form-panel">
    <div class="auth-form-wrap">
      ...
      <div class="auth-panel active" id="panelLogin">
        ...
        <button class="auth-submit" id="btnLogin" onclick="authLogin()"
          aria-label="Zaloguj się do konta">Zaloguj się</button>

        <div class="auth-divider">lub</div>

        <button class="auth-google" onclick="authGoogle()" id="loginGoogleBtn">
          Kontynuuj z Google
        </button>
      </div>
      ...
      <div class="auth-panel" id="panelRegister">
        ...
        <div class="auth-fields">
          ...
          <!-- Client-only extra (placeholder for future fields) -->
          <div class="biz-extra show" id="clientExtra"></div>
        ...
        <button class="auth-submit" id="btnRegister" onclick="authRegister()"
          aria-label="Utwórz nowe konto w Lumina">Utwórz konto</button>

        <div class="auth-divider">lub</div>

        <button class="auth-google" onclick="authGoogle()" id="registerGoogleBtn">
          Kontynuuj z Google
        </button>
      </div>
...
<script>
// Inject Google logo from template into both Google buttons
(function() {
  const tpl = document.getElementById('googleLogoTpl');
  if (!tpl) return;
  document.querySelectorAll('.auth-google').forEach(btn => {
    btn.prepend(tpl.content.cloneNode(true));
  });
})();
